...
const API_KEY = "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";

const examplePrompts = [
    "A magic forest with glowing plants and fairy homes among giant mushrooms",
    "An old steampunk airship floating through golden clouds at sunset",
    "A future Mars colony with glass domes and garderns against red mountains",
    "A dragon sleeping on gold coins in a crystal cave",
    "An underwater kingdom with merepeople and glowing coral buildings",
    "A floating island with waterfalls pouring into clouds below",
    "A witch`s cottage in fall with magic herbs in the gardern",
    "A robort painting in a sunny studio with art supplies around it",
